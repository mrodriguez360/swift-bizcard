  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-gradient-primary flex items-center justify-center">
      <div className="w-full px-4 py-10">
        <Card className="mx-auto max-w-[1100px] rounded-2xl shadow-[var(--shadow-soft)] bg-[hsl(var(--card-hero))] text-[hsl(var(--card-hero-foreground))] border-[hsl(var(--border-hero))]">
