      ...
      <ul className="flex flex-wrap items-center justify-center gap-3 md:gap-4">
        {items.map((it, idx) => (
          <React.Fragment key={it.area}>
            ...
            >
              <div className="flex items-center gap-3 rounded-xl bg-card/40 backdrop-blur-md px-3 py-2 md:px-4 md:py-3 shadow-sm transition-all duration-200 focus-within:ring-2 focus-within:ring-primary/40 hover:ring-2 hover:ring-primary/40">
